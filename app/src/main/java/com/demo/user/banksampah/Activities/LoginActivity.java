...
import com.demo.user.banksampah.RegisterActivities.OtpActivity;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected String var_noHP, var_password, var_result, var_imei;
    ...
    private void displayLogin(String resp_content){
        String[] field_name = {"message", "nama", "foto", "role_user", "point", "latlong", "token",
                "no_telepon", "alamat", "id", "email"};
        ...
        try {
            ...
            if(message.equalsIgnoreCase("Logged In")){
                ...
                pref_strPoint = jsonPost.getString(field_name[4]);
                pref_strLatlong = jsonPost.getString(field_name[5]);
                pref_token = jsonPost.getString(field_name[6]);
                pref_strNoHp = jsonPost.getString(field_name[7]);
                pref_strAlamat = jsonPost.getString(field_name[8]);
                pref_strID = jsonPost.getString(field_name[9]);
                pref_strEmail = jsonPost.getString(field_name[10]);

                session.createLoginSession(pref_strNoHp, pref_strNama, pref_strPoint, pref_strLatlong,
                        pref_strAlamat, pref_strEmail, pref_strFoto, pref_strID, pref_role_user);
